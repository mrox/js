...
function STMCPlayer(ws_src) {
    ...
    this.nalu_l = null;
    this.ts_l = 0;
    this.wsConnected_timeout = 25000;
...
STMCPlayer.prototype.deleteMe =  function() {
    console.log("delete WS:",typeof _Helper.seqMap[this.seqM_idx]);
    clearTimeout(this.wsConnected_timer);
    this._ws.close();
    if (typeof _Helper.seqMap[this.seqM_idx] != 'undefined'){
	delete _Helper.seqMap[this.seqM_idx];
    }
}
